...
if dataset == 'ActivityNet':
    ...
    gpu_id = 0  
    word_embedding_path = '../data/glove.840B.300d_dict.npy'
    video_data_path_train = '../data/Tacos/h5py_fc6_16/cont_caption_random/train.txt'
    video_data_path_val = '../data/Tacos/h5py_fc6_16/cont_captions/test.txt'
    video_feat_path = '../data/Tacos/h5py_fc6_16/cont_captions'
